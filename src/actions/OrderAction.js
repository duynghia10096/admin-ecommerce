...
import {GET_ALL_ORDER_REQUEST, GET_ALL_ORDER_SUCCESS, GET_ALL_ORDER_FAIL, GET_ORDER_DETAIL_REQUEST, GET_ORDER_DETAIL_SUCCESS, GET_ORDER_DETAIL_FAIL, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELETE_ORDER_FAIL, GET_ORDER_ITEM_DETAIL_REQUEST, GET_ORDER_ITEM_DETAIL_SUCCESS, GET_ORDER_ITEM_DETAIL_FAIL} from "../constants/orderConstant"
...
export const getOrderItemDetail = (orderId) => async (dispatch) => {
    dispatch({ type: GET_ORDER_ITEM_DETAIL_REQUEST });
    try {
        const response = await axios.get("http://localhost:5000/api/order/orderItem/" + orderId);
